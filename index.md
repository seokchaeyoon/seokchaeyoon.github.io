...
다이어그램의 왼편의 가장 위를 보면 f1 학습기가 있습니다. 이 f1 학습기는 'K'번째 블록을 제외한 "K-1"개의 블록에 대해서 학습을 진행합니다. f2 학습기는 'K-1'번째 블록을 제외한 "K-1"개의 블록에 대해서 학습을 진행합니다. 같은 방식으로 f3 학습기는 'K-2'번째 블록을 제외한 "K-1"개의 블록에 대해서 학습을 진행합니다. 이런 방식으로 학습을 진행하면 총 "K"개의 학습기에 대해서 학습이 진행되게 됩니다.
